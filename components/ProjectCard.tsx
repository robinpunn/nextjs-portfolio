...
const ProjectCard = ({ title, tech, img, link }) => {
  return (
    // card container
    <div className="relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-600 rounded-xl group hover:shadow-bright hover:bg-gradient-to-r from-violet-500 to-fuchsia-500 ease-in duration-200">
      {/*project image*/}
      <Image
